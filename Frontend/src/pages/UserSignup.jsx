...
const UserSignup = () => {
  ...
  return (
    <div className="h-screen overflow-hidden bg-[#ff5900] flex flex-col items-center justify-center px-4">
            ...
            <div>
              ...
              <div className="flex gap-2">
                <input
                  ...
                  type="text"
                  placeholder="First"
                  className="w-1/2 bg-gray-50 border border-gray-200 text-gray-900 text-sm rounded-xl px-3 py-2.5 focus:outline-none focus:border-[#ff5900] focus:bg-white transition placeholder:text-gray-300"
                />
                <input
                  required
                  value={lastName}
      ...
      {/* Terms note */}
      <p className="text-white/40 text-xs text-center mt-3 max-w-xs">
        By creating an account, you agree to RideOn's Terms of Service and
        Privacy Policy.
      </p>
    </div>
  );
